...
def make_menu_panel():
    return html.Div(children=[
        dcc.Tabs(id=Fields.MENU_TABS,
                 ...
                 children=[
            dcc.Tab(label='COLOR', value=Fields.COLOR_MANIPULATION_TAB),
            dcc.Tab(label='SELECT', value=Fields.EXCLUSION_TAB),
            dcc.Tab(label='PROFILE', value=Fields.PERSISTENCE_TAB),
        ]),
